...
if ($choice == "registerPlayer") {
    ...
    if ($res == true) {  // loose comparison — PDO execute() returns 1 not true
        $name = htmlspecialchars("$fn $ln");
            ...
            <div style='background: #1C0A04; padding: 36px 30px;'>
                ...
                <table style='width: 100%; border-collapse: collapse; border-radius: 10px; overflow: hidden;'>
                    ...
                    <tr>
                        ...
                        <td style='padding: 13px 16px; background: rgba(107,58,42,0.15); border-bottom: 1px solid rgba(212,130,74,0.15); color: rgba(255,255,255,0.75); font-size: 14px;'>$ag</td>
                    </tr>
                    <tr>
                        ...
                        <td style='padding: 13px 16px; background: rgba(107,58,42,0.15); border-bottom: 1px solid rgba(212,130,74,0.15); color: #F0C86A; font-weight: bold; font-size: 15px;'>$rt</td>
                    </tr>
                    <tr>
        ...
        sendEmail("peyttabungar@gmail.com", "Admin", "New Player Registered: $name", $body);
